        ...
        <div class="row">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <?php
                $statement = $db->query('SELECT subjects.id, subjects.name,subjects.description,categories.name as category FROM subjects LEFT JOIN categories ON subjects.category =categories.id ORDER BY subjects.id');
                while ($subject=$statement->fetch())
                {
                  ...
                  echo  ' <a href="update.php?id=' .$subject['id'] . '" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>';
                  echo  ' <a href="delete.php?id=' .$subject['id'] . '" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Supprimer matière</a>';
                  echo   '</td>';
                  echo '</tr>';
                }
                Database::disconnect();
